...
namespace Sitecore.T4Class.Generate.Module.BusinessLayer.CSharpFormat
{
	...
	{
		private Sitecore.T4Class.Generate.Module.BusinessLayer.CSharpFormat.CSharpFormat csf; //to format embedded C# code
		...
		public HtmlFormat()
		{
			...
			csf = new Sitecore.T4Class.Generate.Module.BusinessLayer.CSharpFormat.CSharpFormat();
